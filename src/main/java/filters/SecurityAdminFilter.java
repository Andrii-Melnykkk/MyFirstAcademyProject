...
@WebFilter(filterName = "securityAdminFilter", urlPatterns = {"/adminTask/*"})
public class SecurityAdminFilter extends HttpFilter {
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (userRole == ROLE.USER || userRole == ROLE.MANAGER) {
